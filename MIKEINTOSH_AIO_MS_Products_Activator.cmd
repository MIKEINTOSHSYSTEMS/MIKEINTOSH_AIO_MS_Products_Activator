...
::  For command line switches, check https://merqconsultancy.org/
...
echo:
echo:
echo:		    Welcome to MERQ Consultancy Internal IT Support
echo:		  		  Microsoft Products Activator
echo:		        Contact : support@merqconsultancy.org
...
echo:       ______________________________________________________________
echo:
echo:             [1] Activation Troubleshoot via 3rd Party
...
echo:
echo https://merqconsultancy.org/
goto dk_done
)
)
...
echo      Email: support@merqconsultancy.org
)>"%_dest%\Info.txt"
exit /b
